...
class ClientsView  extends View
{
    ...
    public function displayList($list)
    {
        ...
        foreach ($list as $element) {
            ...
            $this->page .= "<td>";
            $this->page .= '<a href="index.php?page=clients&action=Update&id=' . $element['id'] . '" class="text-dark"><i class="fas fa-edit"></i></a></td>';
            $this->page .= "<td>";
            $this->page .= '<a href="index.php?page=Clients&action=Delete&id=' . $element['id'] . '" class="text-dark"><i class="fas fa-dumpster"></i></a></td>';
            $this->page .= "</tr>";
        }
        $this->page .= "</table>";
        $this->display();
    ...
    /**
     * Formulaire pour modifier les données Clients
     */
    public function displayUpdate($titre, $parm)
    {
        $this->page .= "<h1 class='text-center'>" . $titre . "</h1>";
        $this->page .= '<div class="container">
            <form name="form" method="POST" action="index.php?page=clients&action=UpdateDB">
    ...
    public function displayDelete($titre, $parm)
    {
        $this->page .= "<h1 class='text-center'>" . $titre . "</h1>";
        $this->page .= '<div class="container">
            <form name="form" method="POST" action="index.php?page=clients&action=DeleteDB">
            <div class="form-group">
            <input class="form-control" type="hidden" name="parm0" value="' . $parm[0] . '"/>
            <label>Nom</label>
            <input class="form-control" type="text" name="parm1" value="' . $parm[1] . '"/>
